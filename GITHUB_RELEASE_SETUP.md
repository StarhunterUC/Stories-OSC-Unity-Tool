...
git status
git add .
git commit -m "Stories OSC Unity Tool v0.5.5"
git push origin main

git tag -a v0.5.5 -m "Stories OSC Unity Tool v0.5.5"
...
Stories_Of_Yggdrasil_OSC_Contact_System_v0.5.5.zip
Stories_Of_Yggdrasil_OSC_Contact_System_v0.5.5.zip.sha256
```
